...
MixingMatrixRules = {
   Op[Conjugate[Lu[x_, y_]], Ld[x_, z_], rst__] :>
    Op[CKM[y, z], rst],
   ...
   Op[Conjugate[Rl[x_, y_]], Rl[x_, z_],
     rst__] :> (Op[rst] /. y -> z)
