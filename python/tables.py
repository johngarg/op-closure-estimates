...
ALLOWED_PROCESSES = {
    (-HALF, 0, -1, -1): ["p->pi0e+", "p->eta0e+", "n->pi-e+", "p->pi0mu+", "p->eta0mu+", "n->pi-mu+"],
    (HALF, 0, -1, -1): ["p->pi+nu", "n->pi0nu", "n->eta0nu"],
    (HALF, 0, -1, 1): ["p->pi+nu", "n->pi0nu", "n->eta0nu"],
    (-1, 1, -1, -1): ["p->K0e+", "p->K0mu+"],
    (0, 1, -1, -1): ["p->K+nu", "n->K0nu"],
    (0, 1, -1, 1): ["p->K+nu", "n->K0nu"],
    (1, 1, -1, 1): ["n->K+e-", "n->K+mu-"],
    (3 * HALF, 0, -1, 1): ["n->pi+e-", "n->pi+mu-"],
    ## Should not appear
    # (0, -1, -1, -1): ["p->K0e+", "n->K-e+"],
    # (1, -1, -1, -1): ["n->K0nu"],
    # (1, -1, -1, 1): ["n->K0nu"],
...
for p, q, r, s in list(itertools.product(*[[0, 1]] * 4)):
    ...
    ] = f"- V[{s}, sp] * G['udqlHHD'][{p}, {q}, {r}, sp] * VEV**2 / (2*LAMBDA**2), (sp, 0, 2)"
